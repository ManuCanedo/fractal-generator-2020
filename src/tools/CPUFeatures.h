...
static int SupportsIntelVectorExtensions()
{
    static int Intel4thGenFeaturesAvailable = -1;

    if (Intel4thGenFeaturesAvailable < 0)
        Intel4thGenFeaturesAvailable = CheckIntelFeatures();
